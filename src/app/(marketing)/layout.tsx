      ...
      <div className="fixed top-0 left-0 right-0 z-[60] h-9 bg-secondary text-on-secondary text-xs tracking-wide flex items-center px-4 md:px-margin-desktop">
        <div className="flex items-center justify-between w-full max-w-container-max mx-auto">
          <div className="hidden md:flex items-center gap-2">
            <Link href="/about" className="hover:text-tertiary transition-colors duration-150">About Us</Link>
          ...
          <div className="hidden md:flex items-center gap-2">
            <Link href="/reviews" className="hover:text-tertiary transition-colors duration-150">Customer Reviews</Link>
            <span className="text-on-secondary/30">|</span>
            <Link href="/contact" className="hover:text-tertiary transition-colors duration-150">Contact Us</Link>
          </div>
        </div>
      </div>
