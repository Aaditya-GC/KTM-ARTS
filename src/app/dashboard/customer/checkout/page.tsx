          ...
          <div className="sticky top-6 space-y-6">
            ...
            <div className="space-y-3">
              {items.map((item) => (
                <div key={item.artworkId} className="flex items-center gap-3">
                  ...
                  <span className="text-[14px] text-on-surface shrink-0">{formatNpr(item.priceNpr)}</span>
                </div>
              ))}
            </div>
            ...
            <div className="border-t border-outline pt-4 space-y-2">
              <div className="flex justify-between text-[14px]">
                ...
                <span className="text-on-surface">{formatNpr(total)}</span>
              </div>
              <div className="flex justify-between text-[14px]">
            ...
            <div className="border-t border-outline pt-4 flex justify-between items-center">
              ...
              <span className="text-[14px] font-bold text-primary">{formatNpr(total)}</span>
            </div>
          </div>
        </div>
      </div>
